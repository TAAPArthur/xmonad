...
source=('git://github.com/TAAPArthur/xmonad.git' 'xmonad.svg')
#source=('git://github.com/xmonad/xmonad.git' 'xmonad.svg')
md5sums=('SKIP'
...
prepare() {
  gendesk -f --pkgname "${pkgname/-git}" --pkgdesc "$pkgdesc"
}
